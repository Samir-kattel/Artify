...
<body>
	...
	<div class="flex-box">
		<div class="left">
			...
			<div class="images">
				<div class="small-img">
					<img src="${pageContext.request.contextPath}/images/p1.png"
						onclick="showImg(this.src)" />
				</div>
				<div class="small-img">
					<img src="${pageContext.request.contextPath}/images/p2.png"
						onclick="showImg(this.src)" />
				</div>
				<div class="small-img">
					<img src="${pageContext.request.contextPath}/images/p3.png"
						onclick="showImg(this.src)" />
				</div>
				<div class="small-img">
					<img src="${pageContext.request.contextPath}/images/p4.png"
						onclick="showImg(this.src)" />
				</div>
			</div>
		</div>
		...
		<div class="right">
			<div class="url">
				Fashion > Clothes > <span style="color: black">${product.name}</span>
			</div>
			<div class="pname">${product.name}</div>
			<c:if test="${not empty loggedUserDetails}">
				<p>${loggedUserDetails}</p>
			</c:if>
			<div class="ratings">
			...
			<div class="product-details-div">
				<span style="font-family: 'Sansation'">Product Details</span> <i
				...
				<c:choose>
					<c:when test="${not empty loggedInEmail}">
						<button class="buy-btn"
							onclick="location.href='${pageContext.request.contextPath}/addtoorder?id=${product.id}&email=${loggedInEmail}'">
							Buy Now</button>
					</c:when>
					<c:otherwise>
						<button class="buy-btn" onclick="alert('Please login to Order');">
							Buy Now</button>
					</c:otherwise>
				</c:choose>
				<c:choose>
					...
					<c:when test="${not empty loggedInEmail}">
						<button class="cart-btn"
							onclick="location.href='${pageContext.request.contextPath}/addtocart?id=${product.id}&email=${loggedInEmail}'">
							<i class="fa-solid fa-cart-shopping" style="margin-right: 0.5rem"></i>Add
							to Cart
						</button>
					</c:when>
					<c:otherwise>
	...
	<div class="recomended-main">
		<div class="recomended-product-main-container">
